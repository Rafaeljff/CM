...
%um telefone tem em media -100dbm de sensibilidade ao sinal(-
...
%     raytrace([tx1,tx2,tx3,tx4,tx5,tx6,tx7], rx, rtpm)
     sc = [0 0.9 0];
   link(rx,txmax,"freespace","SuccessColor",sc)
show(rx);
 end
...
%---------------------------------------------------------------------------------------------
%potencia recebida nos recetores em funcao da posicao dos recetores durante o trajeto
% plot(ss1)
% hold on
% plot(ss2)
% hold on
...
% ylabel('Potencia Recebida (dBm)')%
 % legend({'Eb1','Eb2','Eb3','Eb4','Eb5','Eb6','Eb7'},'Location','southwest')  
% legend({'Eb2','Eb3','Eb6'},'Location','southwest')  
